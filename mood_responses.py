"""
1. Python Modules & Data Handling Assignment
...
responds with a custom message based on the mood entered. - Code Example:
...
def mood_response(mood):
    if mood.lower() == "happy":
        ...
        print(f"Please provide the response happy, sad, or excited.")